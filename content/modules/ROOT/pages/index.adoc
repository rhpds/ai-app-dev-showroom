...
NOTE: To use the Terminal tab with the OpenShift CLI, you'll need to log in first. Run the following command in the Terminal:

[source,bash,role=execute,subs="attributes+"]
----
oc login -u {user} -p {password} https://kubernetes.default.svc --insecure-skip-tls-verify=true
----
