...
. Once logged in, you should see the `ai-app-dev-{user}` application. Click on it to see its details.
+
image::argocd-app-overview.png[ArgoCD dashboard showing application,link=self,window=blank,width=700]
...
. Switch to the **Developer Hub** tab and navigate to your component (you may need to sign in again). To find it, click on **Catalog** in the left menu, then filter by "Owned" and click on your component (named `ai-app-dev-{user}`).
